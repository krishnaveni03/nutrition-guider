...
def model_predict(img_path , model):
    ...
    if preds == 0:
        preds = "This Item is Burger and nutrients list is A typical fast-food burger contains approximately 20-30 grams of fat, with variations depending on the size and toppings. It typically provides around 12-15 grams of protein. However, these values can vary widely depending on the type of burger and ingredients used. "

    elif preds == 1:
        preds = "This Item is Butter Naan.\n Butternut squash is low in fat, containing approximately 0.2 grams of fat per 100 grams.\n It is a good source of dietary fiber and provides around 1 gram of protein per 100 grams, making it a healthy, low-fat addition to a balanced diet"
